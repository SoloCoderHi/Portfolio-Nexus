...
export const setAuthToken = (token: string | null) => {
  if (token) {
    ...
    expenseClient.defaults.headers.common["Authorization"] = `Bearer ${token}`;
  } else {
    ...
    delete expenseClient.defaults.headers.common["Authorization"];
  }
};
...
export const setUserId = (userId: string | null) => {
  if (userId) {
    ...
    expenseClient.defaults.headers.common["X-User-Id"] = userId;
  } else {
    ...
    delete expenseClient.defaults.headers.common["X-User-Id"];
  }
};
